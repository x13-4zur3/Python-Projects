...
class HangmanGame:
    def __init__(self, master):
        ...
        self.attempts_left = 7  # Maximum attempts

        self.initialize_gui()

    def choose_secret_word(self):
        """Fetch a random word from an API or use fallback words if the request fails."""
        try:
            ...
            print(f"Error: {e}, using a fallback word.")
    ...
    def initialize_gui(self):
        ...
        self.word_display = tk.Label(self.master, text="_ " * len(self.secret_word), font=("Helvetica", 30),
                                     bg='light blue')
        self.word_display.pack(pady=(20, 10))

        self.chances_label = tk.Label(self.master, text=f"Chances Left: {self.attempts_left}",
                                      font=("Helvetica", 16, "bold"), fg="red", bg='light blue')
        self.chances_label.pack(pady=(0, 20))
    ...
    def draw_face(self):
        ...
        self.hangman_canvas.create_arc(140, 85, 170, 105, start=0, extent=-180, fill="black")  # Mouth
    ...
    def guess_letter(self, letter):
        if letter in self.secret_word and letter not in self.correct_guesses:
            ...
            self.chances_label.config(text=f"Chances Left: {self.attempts_left}")
